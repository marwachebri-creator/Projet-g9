...
const translations = {
    fr: { dashboard: "Tableau de bord", dishes: "Plats", orders: "Commandes", tables: "Tables", reservations: "Réservations", employees: "Employés", logout: "Déconnexion", add: "Ajouter", edit: "Modifier", delete: "Supprimer", actions: "Actions", status: "Statut" },
    en: { dashboard: "Dashboard", dishes: "Dishes", orders: "Orders", tables: "Tables", reservations: "Reservations", employees: "Employees", logout: "Logout", add: "Add", edit: "Edit", delete: "Delete", actions: "Actions", status: "Status" },
    ar: { dashboard: "لوحة التحكم", dishes: "الأطباق", orders: "الطلبات", tables: "الطاولات", reservations: "الحجوزات", employees: "الموظفين", logout: "تسجيل خروج", add: "إضافة", edit: "تعديل", delete: "حذف", actions: "إجراءات", status: "الحالة" }
};
    ...
    <div class="table-container">
        <div class="table-header">
            <div class="search-box">
                <input type="text" placeholder="Rechercher..." onkeyup="filterTable(this)">
